														...
														<tr>
															...
															<td  style="line-height: 300px; text-align: center;">
																<div class="hidden-sm hidden-xs btn-group">
																	<form class="pull-left" method="get" action="/focus/{{$v->id}}">
																		{{csrf_field()}}	
																	...
																	<form class="pull-left" method="get" action="/focus/{{$v->id}}/edit">
																	...
																	<form action="/focus/{{$v->id}}" method="post" class="pull-left del">
																		{{method_field('DELETE')}}
																		{{csrf_field()}}
