											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
														...
														<tr>
															...
															<td>
																<img style="max-width: 690px; max-height: 300px;" src="{{$v->profile}}" alt="图片丢失" style="width: 100px; height: 100px;">
															</td>
															...
															<td  style="line-height: 300px; text-align: center;">
																<div class="hidden-sm hidden-xs btn-group">
																	<form class="pull-left" method="get" action="/pro/{{$v->id}}">
																		{{csrf_field()}}	
																	...
																	<form class="pull-left" method="get" action="/pro/{{$v->id}}/edit">
																	...
																	<form action="/pro/{{$v->id}}" method="post" class="pull-left del">
																		{{method_field('DELETE')}}
																		{{csrf_field()}}
